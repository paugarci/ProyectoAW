...
{
    //  Constants
    private const FORM_ID = 'update_order_form';
    ...
    protected function processForm($data)
    {
        ...
        if (!$result)
            $this->m_Errors['bad_update_order'] = 'No se ha podido cancelar el pedido.';
    }
    protected function generateFormFields($data)
    {
        return <<<HTML
            <button type="submit" class="btn btn-outline-danger" name="orderID" value="{$this->m_OrderID}">Cancelar pedido</button>
        HTML;
    }
}